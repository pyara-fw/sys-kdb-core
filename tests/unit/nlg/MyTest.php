...
class MyTest extends TestCase {
     ...
     * @return void
     */
    function test_sentence_class($data, $expected) {
...
{/trim}{/paragraph}';        
    ...
    function provider_sentence_interfaces() {
        return [
            [
                [
                    'interfaces' => []
     ...
     * @return void
     */
    function test_sentence_interfaces($data, $expected) {
...
{/if}{/trim}{/paragraph}';
     ...
     * @return void
     */
    function test_additional($data, $expected) {
        $tplStr = '{= word|ama}';
